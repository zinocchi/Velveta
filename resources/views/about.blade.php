...
<body class="bg-gray-50">
    ...
    <section class="relative h-96 md:h-screen max-h-[600px] bg-cover bg-center mt-20"
        style="background-image: url('https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')">
        <div class="hero-overlay absolute inset-0 flex items-center justify-center">
            <div class="text-center px-4">
                ...
                <p class="text-xl md:text-2xl text-white max-w-2xl mx-auto">Discover the passion behind every cup of
                    Velveta Coffee</p>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="md:w-1/2 fade-in">
                    <img src="https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        alt="Coffee Shop Interior" class="rounded-xl shadow-xl w-full h-auto">
                </div>
                <div class="md:w-1/2 fade-in">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-playfair">About Us</h2>
                    <div class="space-y-4 text-gray-700">
                        <p>Velveta Coffee, also known as Sunset Coffee, offers delightful coffee and beverages to help
                            you relax under the beautiful sunset.</p>
                        <p>We are committed to providing you with a moment of respite from the hustle and bustle of
                            daily life.</p>
                        <p>Every cup of our coffee is brewed with love and care, using premium coffee beans sourced from
                            local farmers.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 md:py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Creating unforgettable coffee experiences with the
                    best quality</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md text-center fade-in" style="transition-delay: 0.4s">
                    ...
                    <p class="text-gray-600">We are committed to sustainable and environmentally friendly business
                        practices</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 md:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Our signature products that make Velveta Coffee
                    special</p>
            </div>
            ...
            <div class="space-y-12">
                <div class="flex flex-col md:flex-row items-center gap-8 bg-gray-50 p-6 rounded-xl fade-in">
                    <img src="https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        alt="Ballerinna Cappuccino" class="w-full md:w-1/3 h-64 object-cover rounded-lg">
                    <div class="md:w-2/3">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Ballerinna Cappuccino</h3>
                        <p class="text-gray-600 mb-4">Authentic Italian cappuccino with our barista's sweet touch. Made
                            with high-quality espresso and perfectly steamed milk.</p>
                        <div class="flex items-center space-x-2">
                            <span class="bg-red-100 text-red-800 text-sm font-medium px-2.5 py-0.5 rounded">Best
                                Seller</span>
                ...
                <div class="flex flex-col md:flex-row items-center gap-8 bg-gray-50 p-6 rounded-xl fade-in"
                    ...
                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/IcedMatchaTeaLatte.jpg?impolicy=1by1_wide_topcrop_630"
                        alt="Our Matcha" class="w-full md:w-1/3 h-64 object-cover rounded-lg">
                    <div class="md:w-2/3">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Our Matcha</h3>
                        <p class="text-gray-600 mb-4">Delicious matcha for green tea lovers. Made from ceremonial grade
                            matcha powder from Japan, perfectly whisked.</p>
                        <div class="flex items-center space-x-2">
                            <span
                                class="bg-green-100 text-green-800 text-sm font-medium px-2.5 py-0.5 rounded">Healthy</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center gap-8 bg-gray-50 p-6 rounded-xl fade-in"
                    ...
                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/IcedShakenEspresso.jpg?impolicy=1by1_wide_topcrop_630"
                        alt="Americanno" class="w-full md:w-1/3 h-64 object-cover rounded-lg">
                    <div class="md:w-2/3">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Americanno</h3>
                        <p class="text-gray-600 mb-4">For true black coffee connoisseurs. Strong espresso diluted with
                            hot water, delivering authentic coffee flavor.</p>
                        <div class="flex items-center space-x-2">
                            <span
                                class="bg-blue-100 text-blue-800 text-sm font-medium px-2.5 py-0.5 rounded">Strong</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="https://maps.google.com" target="_blank"
                    class="menu-item bg-white rounded-xl shadow-md overflow-hidden fade-in">
                    <img src="https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        alt="Jakarta Branch" class="w-full h-48 object-cover">
                    <div class="p-4">
                ...
                <a href="https://maps.google.com" target="_blank"
                    ...
                    <img src="https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        alt="Bandung Branch" class="w-full h-48 object-cover">
                    <div class="p-4">
                ...
                <a href="https://maps.google.com" target="_blank"
                    ...
                    style="transition-delay: 0.2s">
                    <img src="https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        alt="Yogyakarta Branch" class="w-full h-48 object-cover">
                    <div class="p-4">
                ...
                <a href="https://maps.google.com" target="_blank"
                    ...
                    <img src="https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                        alt="Surabaya Branch" class="w-full h-48 object-cover">
                    <div class="p-4">

        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    @csrf
                    <div>
                        <label for="login" class="block text-sm font-medium mb-2 text-gray-700">* Username or
                            Email</label>
                    ...
                    <div class="space-y-2 pt-2">
                        <a href="#"
                            class="block text-sm text-velveta hover:text-red-800 transition duration-200">Forgot your
                            username?</a>
                        <a href="#"
                            class="block text-sm text-velveta hover:text-red-800 transition duration-200">Forgot your
                            password?</a>
            ...
            <div class="text-center mt-8">
                <p class="text-gray-600">Don't have an account?
                    <a href="{{ route('register') }}"
                        class="text-velveta font-medium hover:text-red-800 transition duration-200">Register now</a>
                </p>
            </div>
        </div>
    </main>

        ...
        <div class="bg-white rounded-xl shadow-sm p-6 sticky top-32">
          ...
          <div class="mb-8">
            ...
            <ul class="space-y-2">
              ...
              <li><a href="hot-tea.html" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Hot Tea</a></li>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="breakfast.html" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Breakfast</a></li>
              <li><a href="bakery.html" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Bakery</a></li>
              <li><a href="treats.html" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Treats</a></li>
              <li><a href="lunch.html" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Lunch</a></li>
            </ul>
          </div>
        </div>
      </aside>

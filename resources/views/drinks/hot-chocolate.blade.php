      ...
      <div class="flex justify-between items-center h-20">
        <div class="flex items-center space-x-8">
          ...
          <nav class="hidden md:flex space-x-8">
            ...
            <a href="reward.html" class="text-gray-900 hover:text-red-700 font-semibold uppercase text-sm tracking-wider transition-colors duration-300">Reward</a>
          </nav>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 sticky top-32">
          ...
          <div class="mb-8">
            ...
            <ul class="space-y-2">
              ...
              <li><a href="hot-chocolate" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation active-category">Hot Chocolate & More</a></li>
            </ul>
          </div>

      ...
      <aside class="w-full md:w-64 flex-shrink-0 mb-8 md:mb-0 md:mr-8">
        <div class="bg-white rounded-xl shadow-sm p-6 sticky top-32">
          ...
          <div class="mb-8">
            ...
            <ul class="space-y-2">
              <li><a href="hot-coffee.html" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation active-category">Hot Coffee</a></li>

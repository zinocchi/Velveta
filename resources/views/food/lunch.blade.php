        ...
        <div class="bg-white rounded-xl shadow-sm p-6 sticky top-32">
          ...
          <div class="mb-8">
            ...
            <ul class="space-y-2">
              ...
              <li><a href="{{ route('drinks.hot-tea') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Hot Tea</a></li>
              <li><a href="{{ route ('drinks.cold-tea') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Cold Tea</a></li>
              <li><a href="{{ route('drinks.hot-chocolate') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation ">Hot Chocolate & More</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="{{ route('food.breakfast') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Breakfast</a></li>
              <li><a href="{{ route('desert.bakery') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Bakery</a></li>
              <li><a href="{{ route('desert.treats') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Treats</a></li>
              <li><a href="{{ route('food.lunch') }}" class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300 underline-animation">Lunch</a></li>
            </ul>
          </div>
        </div>
      </aside>

...
<body class="overflow-x-hidden">
  ...
  <section class="mt-20 md:mt-24 relative overflow-hidden">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 rounded-xl overflow-hidden">
      <div class="bg-red-700 text-white px-6 py-16 md:py-24 lg:py-32 flex flex-col justify-center items-center text-center animate__animated animate__fadeInLeft">
        ...
        <button class="px-8 py-3 border-2 border-white rounded-full font-semibold hover:bg-white hover:text-red-700 transition-colors">
          View the menu
        </button>
      </div>
      
      <div class="h-64 md:h-auto bg-cover bg-center animate__animated animate__fadeInRight" style="background-image: url('https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-97315.jpg')"></div>
    </div>
    
    <div class="absolute top-1/4 left-10 w-8 h-8 rounded-full bg-amber-800 opacity-30 floating" style="animation-delay: 0.2s;"></div>
    <div class="absolute top-1/3 right-20 w-6 h-6 rounded-full bg-amber-600 opacity-40 floating" style="animation-delay: 0.4s;"></div>
    <div class="absolute bottom-1/4 left-1/4 w-5 h-5 rounded-full bg-amber-900 opacity-30 floating" style="animation-delay: 0.6s;"></div>
</section>
  <section class="my-16 md:my-24 max-w-7xl mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-2 rounded-xl overflow-hidden shadow-xl transform transition-all hover:scale-[1.01] duration-500">
      <div class="h-64 md:h-auto bg-cover bg-center" style="background-image: url('https://i.pinimg.com/736x/fe/dd/69/fedd693b88559124917599d42495b61e.jpg')"></div>
      <div class="bg-amber-800 text-white px-8 py-12 md:py-16 lg:py-20 flex flex-col justify-center items-center text-center">
        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 font-montserrat">It's a great day for free coffee</h2>
        ...
        <button class="px-8 py-3 border-2 border-white rounded-full font-semibold hover:bg-white hover:text-amber-800 transition-colors duration-300">
          Join now
        </button>
      </div>
    </div>
  ...
  <section class="my-16 md:my-24 max-w-7xl mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-2 rounded-xl overflow-hidden shadow-xl transform transition-all hover:scale-[1.01] duration-500">
      <div class="order-2 md:order-1 bg-gray-700 text-white px-8 py-12 md:py-16 lg:py-20 flex flex-col justify-center items-center text-center">
        <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 font-montserrat">Nondairy milk, no extra charge</h2>
        <p class="text-lg mb-8 max-w-md">
          Customize your drink with your favorite nondairy milk—like soy, coconut, almond or oat—for no additional charge.
        </p>
        <button class="px-8 py-3 border-2 border-white rounded-full font-semibold hover:bg-white hover:text-gray-700 transition-colors duration-300">
          Order now
        </button>
      </div>
      <div class="order-1 md:order-2 h-64 md:h-auto bg-cover bg-center" style="background-image: url('https://content-prod-live.cert.starbucks.com/binary/v2/asset/137-97469.jpg')"></div>
    </div>
  </section>
  ...
  <section class="my-16 md:my-24 max-w-7xl mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
        <div class="h-64 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')"></div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600 mb-4">Creamy caramel meets our premium espresso in this fan favorite.</p>
          <button class="text-red-700 font-semibold hover:underline">Learn more</button>
        </div>
      </div>
      <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    buttons.forEach(button => {
      ...
      button.addEventListener('mouseenter', () => {
        ...
        if (button.classList.contains('cta-button') || button.classList.contains('join')) {

            ...
            <aside class="w-full md:w-64 flex-shrink-0 mb-8 md:mb-0 md:mr-8">
                <div class="bg-white rounded-xl shadow-sm p-6 sticky top-32">
                    ...
                    <div class="mb-8">
                        ...
                        <ul class="space-y-2">
                            <li><a href="#hot-coffee"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Hot
                                    Coffee</a></li>
                            <li><a href="#cold-coffee"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Cold
                                    Coffee</a></li>
                            <li><a href="#hot-tea"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Hot
                                    Tea</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="#breakfast"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Breakfast</a>
                            </li>
                            <li><a href="#bakery"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Bakery</a>
                            </li>
                            <li><a href="#treats"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Treats</a>
                            </li>
                            <li><a href="#lunch"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Lunch</a>
                            </li>
                            <li><a href="#snack"
                                    class="sidebar-link text-gray-600 hover:text-red-700 block py-1 transition-colors duration-300">Snacks</a>
                            </li>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/CaffeLatte.jpg"
                                        alt="Hot Coffee" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/VanillaSweetCreamColdBrew.jpg"
                                        alt="Cold Coffee" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/HoneyCitrusMintTea.jpg"
                                        alt="Hot Tea" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/IcedBlackTea.jpg"
                                        alt="Cold Tea" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/bev/HotChocolate.jpg"
                                        alt="Hot Chocolate" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/food/EggPestoMozzarellaSandwich.jpg"
                                        alt="Breakfast" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/food/SBX20210915_Croissant-onGreen.jpg"
                                        alt="Bakery" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/food/SBX20181129_BirthdayCakePop.jpg"
                                        alt="Treats" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden p-4 h-full flex flex-col">
                                <div class="relative overflow-hidden rounded-lg mb-4">
                                    <img src="https://globalassets.starbucks.com/digitalassets/products/food/SBX20220207_GrilledCheeseOnSourdough_US.jpg"
                                        alt="Lunch" class="menu-img w-full h-40 object-cover rounded-lg">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    </div>
                                </div>

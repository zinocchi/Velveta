    ...
    <body class="bg-gray-50">
        ...
        <section class="pt-32 pb-20 bg-gradient-to-r from-red-700 to-amber-900 text-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="text-xl md:text-2xl max-w-3xl mx-auto mb-8">Your loyalty deserves the best perks. Earn points
                    with every purchase and unlock exclusive benefits.</p>
                <div class="flex justify-center space-x-4">
                    <a href="#join"
                        class="px-8 py-3 bg-white text-red-700 rounded-full font-bold hover:bg-gray-100 transition-colors duration-300">Join
                        Now</a>
                    <a href="#how-it-works"
                        class="px-8 py-3 border-2 border-white text-white rounded-full font-bold hover:bg-white hover:text-red-700 transition-colors duration-300">How
                        It Works</a>
                </div>
                <div class="mt-12 floating">
                    <img src="https://cdn-icons-png.flaticon.com/512/3132/3132693.png" alt="Reward Cup"
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="fade-in">
                        <div class="bg-white p-8 rounded-xl shadow-sm h-full reward-card">
                            ...
                            <p class="text-gray-600 text-center">Sign up for free and start earning points immediately
                    ...
                    <div class="fade-in" style="transition-delay: 0.2s">
                        <div class="bg-white p-8 rounded-xl shadow-sm h-full reward-card">
                            ...
                            <p class="text-gray-600 text-center">Get 1 point for every Rp10,000 spent. Bonus points on
                    ...
                    <div class="fade-in" style="transition-delay: 0.4s">
                        <div class="bg-white p-8 rounded-xl shadow-sm h-full reward-card">
                            ...
                            <p class="text-gray-600 text-center">Exchange points for free drinks, discounts, and
                                exclusive Velveta merchandise.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="fade-in">
                        <div class="bg-gray-50 border border-gray-200 p-8 rounded-xl h-full reward-card">
                            <div class="text-center mb-6">
                                <div
                                    class="w-20 h-20 bg-gray-300 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <ul class="space-y-3 mb-6">
                                <li class="flex items-start">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-700 mr-2 mt-0.5"
                    ...
                    <div class="fade-in" style="transition-delay: 0.2s">
                        <div
                            class="bg-amber-50 border border-amber-200 p-8 rounded-xl h-full reward-card transform scale-105 pulse">
                            <div class="text-center mb-6">
                                <div
                                    class="w-20 h-20 bg-amber-200 rounded-full flex items-center justify-center mx-auto mb-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-amber-600"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="fade-in" style="transition-delay: 0.4s">
                        <div class="bg-gray-100 border border-gray-300 p-8 rounded-xl h-full reward-card">
                            <div class="text-center mb-6">
                                <div
                                    class="w-20 h-20 bg-gray-400 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <section id="join" class="py-16 bg-red-700 text-white">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in">
                ...
                <p class="text-xl mb-8 max-w-2xl mx-auto">Sign up now and get your first drink on us! Plus, earn double
                    points for your first month.</p>
                <div class="flex flex-col sm:flex-row justify-center gap-4 max-w-md mx-auto">
                    <input type="email" placeholder="Your email address"
                        class="px-4 py-3 rounded-full text-gray-900">
                    <button
                        class="px-6 py-3 bg-white text-red-700 rounded-full font-bold hover:bg-gray-100 transition-colors duration-300">Join
                        Now</button>
                </div>
                <p class="text-sm mt-4 text-red-200">Already a member? <a href="login.html" class="underline">Sign
                        in</a></p>
            </div>
        </section>
        ...
        <section class="py-16 bg-gray-50">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-center text-gray-900 mb-12 font-montserrat">Frequently Asked
                    Questions</h2>
                ...
                <div class="space-y-4">
                    <div class="bg-white p-6 rounded-xl shadow-sm fade-in">
                        <button class="faq-toggle w-full flex justify-between items-center">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 text-red-700 transform transition-transform duration-300"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div class="faq-content mt-3 text-gray-600 hidden">
                            <p>You earn 1 point for every Rp10,000 spent at any Velveta Coffee location. Just provide
                                your phone number or scan your member QR code at checkout to earn points. Special
                                promotions may offer bonus points on select items.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm fade-in" style="transition-delay: 0.1s">
                        ...
                        <div class="faq-content mt-3 text-gray-600 hidden">
                            <p>You can redeem rewards through the Velveta mobile app or by telling your barista at
                                checkout. Available rewards will be shown in your account based on your current point
                                balance and membership tier.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm fade-in" style="transition-delay: 0.2s">
                        ...
                        <div class="faq-content mt-3 text-gray-600 hidden">
                            <p>Points expire after 6 months of account inactivity. As long as you make at least one
                                purchase every 6 months, your points will remain active. We'll send you reminders before
                                any points are set to expire.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-400">
                            <li><a href="menu.html" class="hover:text-white transition-colors duration-300">Menu</a>
                            </li>
                            <li><a href="about.html" class="hover:text-white transition-colors duration-300">About
                                    Us</a></li>
                            <li><a href="#" class="hover:text-white transition-colors duration-300">Rewards</a>
                            </li>
                            <li><a href="locations.html"
                                    class="hover:text-white transition-colors duration-300">Locations</a></li>
                        </ul>
                    </div>
                    <div>
